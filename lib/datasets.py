...
# from .datasethyper import Label_train_hsi,Label_true_hsi,Label_test_hsi
from .datasethyper import HSI_data
...
def build_dataset(is_train, args, folder_name=None):
    ...
    if args.data_set == 'CIFAR10':
        ...
        nb_classes = 10
    elif args.data_set in ('Indian', 'Houston', 'Pavia', 'KSC', 'Salinas'):
        dataset, nb_classes = HSI_data(is_train, args.data_set, args.in_chans)
        # nb_classes = 16
    # elif args.data_set == 'Houston':
    #     dataset = HSI_data(is_train)
    #     nb_classes = 15
    # elif args.data_set == 'Pavia':
    #     dataset = HSI_data(is_train)
    #     nb_classes = 9
...
# def HSI_data(is_train):
#   if is_train:
#     return Label_train_hsi
#   else:
#     return Label_test_hsi